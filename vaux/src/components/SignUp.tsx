...
function SignUpContent() {
    ...
    return (
        <div className="lg:p-12 md:p-32 sm:p-20 p-8 w-full lg:w-[40%]">
            ...
            <div className='flex flex-col gap-3 items-center'>
                ...
                <div className='w-full'>
                    <form action="#" method="POST">
                        ...
                        <div className='mb-8'>
                            <button type="submit" className="bg-primary text-white font-semibold rounded-xmd py-2 px-4 w-full">SIGNUP</button>
                        </div>
                    </form>
                </div>
            </div>
