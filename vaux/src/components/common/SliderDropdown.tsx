...
export default function SliderDropdown({positionStyles, defaultValue, min, max, sliderOptions, sliderValue, sliderChanged}: {positionStyles: string, defaultValue: number, min: number, max: number, sliderOptions: Array<any>, sliderValue: number, sliderChanged: (value: number) => void}) {
    return (
