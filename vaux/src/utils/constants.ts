export const Constants = {
	Overview_Labels: {
		...
		detail_descripton: 'At VOAUX, we\'re passionate about the power of voice. We believe that every word has a unique melody, and we\'re here to help you find the perfect voice for your project. Our platform is your gateway to a world of AI voices, each with its own distinctive tone, style, and personality.',
		btn_generate: 'Generate Now',
		explore: 'Explore',
		introduce_voux: 'Introducing VOAUX',
		listen_tts_text: 'Welcome to VOAUX! Simply click \'Listen\' or unleash your creativity by typing your own text here.',
		introduction_list: [
			{
